...
import com.zinedroid.syromalabar.smartcatechism.activity.TouchImageView;
...
public class SlideshowDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        images = (ArrayList<ImageGallery>) getArguments().getSerializable("images");
    ...
    private void displayMetaInfo(int position) {
        ...
        ImageGallery image = images.get(position);
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            Glide.with(getActivity()).load(image.getImagePath())
                    .thumbnail(0.5f)
                    .crossFade()
